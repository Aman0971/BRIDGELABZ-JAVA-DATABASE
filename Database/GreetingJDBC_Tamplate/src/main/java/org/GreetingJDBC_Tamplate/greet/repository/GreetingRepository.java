package org.GreetingJDBC_Tamplate.greet.repository;
...
public class GreetingRepository {
    ...
    public List<Greeting> findAll() {
        String sql = "SELECT g.id, g.message, g.created_by, u.username AS creator "+" FROM greetings g "  + " LEFT JOIN users u ON g.created_by = u.id " + "ORDER BY g.id ASC";
